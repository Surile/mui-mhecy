			...
			if ($.isFunction(self.options.up.callback)) {
				self.pullUpTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="mui-pull-bottom-wrapper" style="width: 100%; height: 30px;background-color: #FFFFFF;padding-top: 10px;text-align: center;line-height: 13px;"><span class="mui-spinner" style="position: relative;bottom: 10px;right: 10px;"></span><span class="mui-pull-loading " style="position: relative;bottom: 18px;">' + self.options.up.contentinit + '</span></div>';
